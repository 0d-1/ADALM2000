...
class OscilloscopeUI(QWidget):
    ...
    def setup_generator_tab(self):
        ...
        lbl_desc = QLabel("L'ADALM2000 génère des bursts de signal périodiques.<br>Par défaut : 40kHz, 60 BPM, 65% ON, +/- 50mV.<br>Vous pouvez ajuster tous les paramètres ci-dessous.")
        ...
        self.spin_bpm.setRange(1.0, 500.0)
        ...
        layout_freq.addWidget(QLabel("Fréquence (Hz) :"))
        self.spin_ref_freq = QDoubleSpinBox()
        self.spin_ref_freq.setRange(1.0, 100000.0)
        self.spin_ref_freq.setDecimals(0)
        self.spin_ref_freq.setValue(40000.0)
        self.spin_ref_freq.setSingleStep(1000.0)
        layout_freq.addWidget(self.spin_ref_freq)
        l_gen.addLayout(layout_freq)

        layout_duty = QHBoxLayout()
        layout_duty.addWidget(QLabel("Position 'ON' (%) :"))
        self.spin_ref_duty = QDoubleSpinBox()
        self.spin_ref_duty.setRange(0.0, 100.0)
        self.spin_ref_duty.setDecimals(1)
        self.spin_ref_duty.setValue(65.0)
        self.spin_ref_duty.setSingleStep(5.0)
        layout_duty.addWidget(self.spin_ref_duty)
        l_gen.addLayout(layout_duty)

        layout_amp = QHBoxLayout()
        layout_amp.addWidget(QLabel("Amplitude (mV) :"))
        self.spin_ref_amp = QDoubleSpinBox()
        self.spin_ref_amp.setRange(1.0, 5000.0)
        self.spin_ref_amp.setDecimals(1)
        self.spin_ref_amp.setValue(50.0)
        self.spin_ref_amp.setSingleStep(5.0)
        layout_amp.addWidget(self.spin_ref_amp)
        l_gen.addLayout(layout_amp)
